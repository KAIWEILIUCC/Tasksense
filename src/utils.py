...
def visualize_plan(plan):
    ...
    root = Tree("🤖 [bold magenta]Generated Plan[/bold magenta]", guide_style="bold cyan")
...
def visualize_agent_response(text_content, title="🤖 Agent Inference", color="cyan", width=None):
    console = Console()
